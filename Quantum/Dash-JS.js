...
for( const course of courses ) {
    ...
    courseCard.innerHTML = `
        ...
        <div class="card-content">
            ...
            <div class="card-info">
                <div class="card-header">
                    ...
                    <img src='${course.isFavorite ? "favourite.svg" : "favourite.svg"}' alt="favourite icon">
                </div>
                <p class="subject">
        ...
        <div class="card-icon">
            ...
            <img src="manage course.svg" class='${course.isActionClickable?'':'disableButton'}' alt="manage course icon">
            <img src="grade submissions.svg" class='${course.isActionClickable?'':'disableButton'}' alt="grade icon">
